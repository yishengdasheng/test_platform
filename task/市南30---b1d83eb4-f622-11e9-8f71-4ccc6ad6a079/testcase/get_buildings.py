...
class get_buildings(unittest.TestCase):
    '''查询建筑名称及id'''
    @classmethod
    def setUpClass(cls):
    ...
    def test_查询建筑名称及id(self):
        ...
        assert_response={"['code']":{"assertEqual":"1"},"['msg']":{"assertEqual":"SUCCESS"},"['data'][0]['name']":{"assertEqual":"武康大楼"},"['data'][1]['name']":{"assertEqual":"馨逸公寓"}}
